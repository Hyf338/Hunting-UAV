...
const uint8_t g_pui8SerialNumberString[] =
{
    2 + (8 * 2),
    USB_DTYPE_STRING,
    '2', 0, '0', 0, '1', 0, '8', 0, '1', 0, '2', 0, '2', 0, '0', 0
};
...
//
//*****************************************************************************
uint32_t USBDRxHandler(void *pvCBData, uint32_t ui32Event,
                   uint32_t ui32MsgValue, void *pvMsgData);
uint32_t USBDTxHandler(void *pvCBData, uint32_t ui32Event,
                   uint32_t ui32MsgValue, void *pvMsgData);
uint32_t USBDControlHandler(void *pvCBData, uint32_t ui32Event,
                        uint32_t ui32MsgValue, void *pvMsgData);
...
{
    9900,	//PX4Éè±¸ÃèÊö·û ´úÌæ USB_VID_TI_1CBE
    USB_PID_SERIAL,
    0,
